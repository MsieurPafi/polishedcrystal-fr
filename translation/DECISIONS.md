...
| **D5** | 2026-08-25 | **Conserver le vouvoiement de la question du genre** — « Vous êtes un garçon ou une fille? » | Question de l'utilisateur : le vouvoiement a-t-il une raison ? Vérifié : c'est une **anomalie isolée** de la VF officielle (1 « vous » contre 25 « tu » dans toute l'introduction du Prof. Chen, qui dit « ton nom » deux répliques plus loin). Mais corriger une incohérence de l'officiel n'entre pas dans notre mandat. Et l'inversion suffit techniquement : `ê` passe en minuscule. → [`REFORMULATIONS.md`](REFORMULATIONS.md) §1 bis. |
| **D4** | 2026-08-25 | **Reformuler les 8 autres phrases qui exigeraient `Ê`, plutôt que prendre une 5ᵉ case** | Décision **de l'utilisateur**. Une 5ᵉ case coûterait `№` (17 lignes d'interface à réécrire) ou l'espagnol de PILAR. Reformuler coûte 8 textes. Les 9 reformulations sont écrites et **mesurées** (aucune ligne > 18 tuiles) dans [`REFORMULATIONS.md`](REFORMULATIONS.md). ⚠️ J'avais annoncé « 21 phrases » : chiffre gonflé par un bug d'alias de mon lecteur. |
...
| ~~P13~~ | 2026-08-24 | ~~Renoncer à `ï`~~ **ANNULÉE le 2026-08-25** : « Caïd » est le terme officiel d'Or/Argent/Cristal, et c'est un nom de dresseur affiché en combat. `<SHARP>` (lecteur de musique) a cédé sa case. → [`CHARMAP.md`](CHARMAP.md) §5 ter. *(motif d'origine :*  | 6 occurrences dans tout le Cristal français, et c'est le seul caractère que le plafond de 125 feuilles laisse sans code. Ramène le besoin de 19 à 18 cases. |
